...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        // Precondition: theCopyrightYear >= 0, theLoanPeriod >= 0
        //                theTitle and theCallNumber must not be null or empty
        // Postcondition: The second library item has been initialized with the specified
        //                values for title, publisher, copyright year, loan period and
        //                call number. The item is not checked out. Item will be used for comparison
        public LibraryItem(LibraryItem item2)
            : this(item2.Title, item2.Publisher, item2.CopyrightYear, item2.LoanPeriod, item2.CallNumber) { }
        ...
        // Precondition:  None
        // Postcondition: When this < item2, method returns negative #
        //                When this == item2, method returns zero
        //                When this > item2, method returns positive #
        public int CompareTo(LibraryItem item2)
        {
            if (item2 == null) //is item 2 null? if so anything is greater than null return positive
                return 1;
            else
                return this.Title.CompareTo(item2.Title); //recursively sort
        }
    }
}
